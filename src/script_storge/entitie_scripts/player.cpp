...
Player::Player(long ID, bool is_prime, Properties_Player* properties_ptr, SpriteType sprite_type) : Character(ID, false, is_prime ? new Properties_Player() : properties_ptr, sprite_type){
